...
const sampleData = [
 {start: 42, end: 50, 文章該当位置: "すんなり終わる事"},
 {start: 46, end: 50, 文章該当位置: "終わる事"},
 {start: 34, end: 61, 文章該当位置: "物を扱う以上そうすんなり終わる事ばかりでもありません。"},
 {start: 49, end: 53, 文章該当位置: "事ばかり"},
 {start: 62, end: 65, 文章該当位置: "不良品"},
 {start: 100, end: 102, 文章該当位置: "返品"},
]
// 包括関係順にソートする関数
// 挿入ソートアルゴリズムで実装
...
// console.log(2, memo_sort(sampleData))
// console.log(3, sort2(sampleData))

function getData() {
  return memo_sort(sampleData)
